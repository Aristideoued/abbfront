...
export class ApiComponent {
  ...
  callApi() {
    const data = {
      token: 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJlUHJvZmlsZSBodHRwczovL2Vwcm9maWxlLmNvZGluZ2FnYWluLmNvbSJ9.h3Rg_kgxhRsewYWtU4HH2I_pWV-KiRB7Y6-8ntqsHl5x_JbtHd2D07JHz_udRYi6L8ZrY1dsIFETQ_oeDFuhyA',
